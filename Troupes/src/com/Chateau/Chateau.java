...
public class Chateau {
	...
	private int quantiteToupepresentesChateau;
	private int tresorChateau;  	
	private boolean appartientChateau;
	private Soldat uniteDeProducion;
	private int nombreDeSoldat;//reserve de troupe ou de soldats
